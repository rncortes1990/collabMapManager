...
$query1=pg_query("select e.id_emergency,e.address ,e.latitude, e.longitude, e.priority, i.imagen  from emergency e, img_prioridades i where e.priority=i.priority and e.end_date IS NULL");
