<?php
  ...
  Kirki::add_field( 'ecommerce_store_settings', array(
  	...
  	'description'		 => sprintf( __( 'The demo homepage is enabled. You can choose from some predefined layouts or make your own %s.', 'ecommerce-store' ), '<a href="' . admin_url( 'themes.php?page=maxstore-welcome' ) . '"><strong>' . __( 'custom homepage template', 'ecommerce-store' ) . '</strong></a>' ),
  	'section'			 => 'ecommerce_store_woo_demo_section',
  	'default'			 => 'style-one',
  	'priority'			 => 10,
  	'choices'			 => array(
