...
function kakina_theme_stylesheets() {
	...
	wp_enqueue_style( 'kakina-stylesheet', get_stylesheet_uri(), array(), '1.2.0', 'all' );
...
function kakina_theme_js() {
	...
	wp_enqueue_script( 'kakina-theme-js', get_template_directory_uri() . '/js/customscript.js', array( 'jquery' ), '1.2.0' );
