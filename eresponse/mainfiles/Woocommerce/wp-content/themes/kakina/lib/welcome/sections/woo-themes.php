	...
	<div class="kakina-tab-pane-half kakina-tab-pane-first-half">
		...
		<div class="kakina-child-theme-container">
			<div class="kakina-child-theme-image-container">
				<img src="<?php echo esc_url( get_template_directory_uri() . '/lib/welcome/img/kakina.jpg' ); ?>" alt="<?php printf( esc_html__( '%s Theme', 'kakina' ), 'Alpha Store'); ?>" />
			</div>
			<div class="kakina-child-theme-details">
				...
				<?php } else { ?>
					<div class="theme-details active">
						...
						<a class="button button-secondary customize right" target="_blank" href="<?php echo esc_url( get_site_url(). '/wp-admin/customize.php' ); ?>"><?php esc_html_e( 'Customize','kakina'); ?></a>
						<div class="kakina-clear"></div>
					</div>
				<?php } ?>
			</div>
			...
			<div class="kakina-child-theme-details">
				<?php if ( 'Giga Store' != $current_theme['Name'] ) { ?>
					<div class="theme-details">
						...
						<a href="<?php echo esc_url( 'http://themes4wp.com/theme/giga-store/' ); ?>" target="_blank" class="button button-primary install right"><?php printf( __( 'Install %s now', 'kakina' ), '<span class="screen-reader-text">Giga Store</span>' ); ?></a>
