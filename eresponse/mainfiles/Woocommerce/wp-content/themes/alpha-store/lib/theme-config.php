...
Kirki::add_field( 'alpha_store_settings', array(
	...
	'description'		 => sprintf( __( 'The demo homepage is enabled. You can choose from some predefined layouts or make your own %s.', 'alpha-store' ), '<a href="' . admin_url( 'themes.php?page=alpha-store-welcome' ) . '"><strong>' . __( 'custom homepage template', 'alpha-store' ) . '</strong></a>' ),
	'section'			 => 'alpha_store_woo_demo_section',
	'default'			 => 'style-one',
	'priority'			 => 10,
	'choices'			 => array(
